	...
	;(function (t, e) {
		...
		;(t.prototype.saveState = function () {
			...
			(t.prototype.pattern = function (u) {
				...
				this.consumeChar("/")
				for (var A = { type: "Flags", loc: { begin: this.idx, end: u.length }, global: !1, ignoreCase: !1, multiLine: !1, unicode: !1, sticky: !1 }; this.isRegExpFlag(); )
					switch (this.popChar()) {
						case "g":
							o(A, "global")
							break
			...
			(t.prototype.quantifier = function (u) {
				...
				if (!(u === !0 && d === void 0))
					return s(d), this.peekChar(0) === "?" ? (this.consumeChar("?"), (d.greedy = !1)) : (d.greedy = !0), (d.type = "Quantifier"), (d.loc = this.loc(A)), d
			}),
				...
				(a = h.map(n, function (g) {
					...
					if (h.isRegExp(y)) {
						...
						return b.length === 1 && b !== "^" && b !== "$" && b !== "." && !y.ignoreCase
							? b
							: b.length === 2 && b[0] === "\\" && !h.contains(["d", "D", "s", "S", "t", "r", "n", "t", "0", "c", "b", "B", "f", "v", "w", "W"], b[1])
								? b[1]
								: e.useSticky
									? gr(y)
									: _r(y)
...
a boolean 2nd argument is no longer supported`)
			...
			i === !0 ? ((this.traceInitMaxIdent = Infinity), (this.traceInitPerf = !0)) : typeof i == "number" && ((this.traceInitMaxIdent = i), (this.traceInitPerf = !0)),
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`)
						...
						;(n.trackStartLines = /full|onlyStart/i.test(n.config.positionTracking)),
							...
							w.isArray(e) ? ((a = { modes: {} }), (a.modes[Ee.DEFAULT_MODE] = w.cloneArr(e)), (a[Ee.DEFAULT_MODE] = Ee.DEFAULT_MODE)) : ((o = !1), (a = w.cloneObj(e)))
					}),
...
` + f
					...
					w.forEach(n.lexerDefinitionWarning, function (p) {
						...
						n.TRACE_INIT("Choosing sub-methods implementations", function () {
							if (
								(Ee.SUPPORT_STICKY ? ((n.chopInput = w.IDENTITY), (n.match = n.matchWithTest)) : ((n.updateLastIndex = w.NOOP), (n.match = n.matchWithExec)),
			...
			(t.prototype.tokenizeInternal = function (e, r) {
				...
				for (var me; L < b; ) {
					...
					for (i = 0; i < Da; i++) {
						...
						if (
							(ut !== !1
								? rn === ut && (c = De)
								: me.isCustom === !0
									? ((g = De.exec(y, L, Z, xe)), g !== null ? ((c = g[0]), g.payload !== void 0 && (f = g.payload)) : (c = null))
							...
							if (((s = me.longerAlt), s !== void 0)) {
								...
								;(p = null),
									fr.isCustom === !0
										? ((g = pr.exec(y, L, Z, xe)), g !== null ? ((o = g[0]), g.payload !== void 0 && (p = g.payload)) : (o = null))
					...
					if (c !== null) {
						...
						;(d = L - vr),
							(_ = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(y, vr, d, an, on)),
...
var ne = R((S) => {
	...
	function ht(t) {
		...
		if (t instanceof Dt) {
			var r = { type: "Terminal", name: t.terminalType.name, label: Oo.tokenLabel(t.terminalType), idx: t.idx },
...
var Gt = R((Ut) => {
	...
	Ut.RestWalker = Io
	function ri(t, e, r) {
		var n = [new ie.Option({ definition: [new ie.Terminal({ terminalType: t.separator })].concat(t.definition) })],
			i = n.concat(e, r)
		return i
	}
})
...
var vt = R((X) => {
	...
	var ni = (function (t) {
		...
		function e() {
			...
			return (
				(r.separator = "-"),
				(r.dslMethods = { option: [], alternation: [], repetition: [], repetitionWithSeparator: [], repetitionMandatory: [], repetitionMandatoryWithSeparator: [] }),
				r
			)
		}
		return (
		...
		for (l.push({ idx: -1, def: t, ruleStack: [], occurrenceStack: [] }); !I.isEmpty(l); ) {
			...
			if (!I.isEmpty(v)) {
				...
				if (_ === i) {
					...
					} else if (u === c - 1) p.push({ nextTokenType: _.terminalType, nextTokenOccurrence: _.idx, ruleStack: d, occurrenceStack: A }), (s = !0)
					else throw Error("non exhaustive match")
					...
					for (var it = _.definition.length - 1; it >= 0; it--) {
						var at = _.definition[it],
							Ke = { idx: u, def: at.definition.concat(I.drop(v)), ruleStack: d, occurrenceStack: A }
						l.push(Ke), l.push(o)
					}
		...
		var n = r.allProductions,
			...
			o = M.map(M.values(a), function (s) {
				var c = M.first(s),
					...
					l = { message: f, type: Ie.ParserDefinitionErrorType.DUPLICATE_PRODUCTIONS, ruleName: t.name, dslName: p, occurrence: c.idx },
					m = Mi(c)
	...
	function hs(t, e, r) {
		...
		return (
			M.contains(e, t) ||
				...
				n.push({ message: i, type: Ie.ParserDefinitionErrorType.INVALID_RULE_OVERRIDE, ruleName: t })),
			n
		)
	}
				...
				function (a, o) {
					var s = M.dropRight(o.definition),
						c = M.map(s, function (f, p) {
							...
							return M.isEmpty(l)
								? {
										message: e.buildEmptyAlternationError({ topLevelRule: t, alternation: o, emptyChoiceIdx: p }),
				...
				if (s.ignoreAmbiguities !== !0) {
					var c = o.idx,
						...
						l = B.map(p, function (m) {
							var v = [m.idx + 1, c + 1],
								u = e.idx === 0 ? "" : e.idx,
								d = n.buildAlternationPrefixAmbiguityError({ topLevelRule: r, alternation: e, ambiguityIndices: v, prefixPath: m.path })
...
var Ui = R((Je) => {
	...
	function Ts(t) {
		return (
			(t = Vr.defaults(t, { errMsgProvider: Di.defaultGrammarValidatorErrorProvider })), ms.validateGrammar(t.rules, t.maxLookahead, t.tokenTypes, t.errMsgProvider, t.grammarName)
		)
	}
		...
		return (
			(t.prototype.initRecoverable = function (e) {
				;(this.firstAfterRepMap = {}),
					(this.resyncFollows = {}),
					(this.recoveryEnabled = de.has(e, "recoveryEnabled") ? e.recoveryEnabled : ks.DEFAULT_PARSER_CONFIG.recoveryEnabled),
			...
			(t.prototype.tryInRepetitionRecovery = function (e, r, n, i) {
				for (
					var a = this,
						...
						m = function () {
							var v = a.LA(0),
								u = a.errorMessageProvider.buildMismatchTokenMessage({ expected: i, actual: p, previous: v, ruleName: a.getCurrRuleFullName() }),
		...
		xs = (function () {
			...
			return (
				(t.prototype.initLooksAhead = function (e) {
					;(this.dynamicTokensEnabled = ge.has(e, "dynamicTokensEnabled") ? e.dynamicTokensEnabled : Ki.DEFAULT_PARSER_CONFIG.dynamicTokensEnabled),
						(this.maxLookahead = ge.has(e, "maxLookahead") ? e.maxLookahead : Ki.DEFAULT_PARSER_CONFIG.maxLookahead),
...
var Hr = R((Be) => {
	...
	function Ds(t, e) {
		...
		return Fs.isUndefined(r) || r.configurable ? (Object.defineProperty(t, Xi, { enumerable: !1, configurable: !0, writable: !1, value: e }), !0) : !1
	}
			...
			return (
				(t.prototype.initTreeBuilder = function (e) {
					if (
						...
						(this.nodeLocationTracking = K.has(e, "nodeLocationTracking") ? e.nodeLocationTracking : Bs.DEFAULT_PARSER_CONFIG.nodeLocationTracking),
						!this.outputCst)
					)
			...
			return (
				...
				(t.prototype.RULE = function (e, r, n) {
					if ((n === void 0 && (n = Xr.DEFAULT_RULE_CONFIG), aa.contains(this.definedRulesNames, e))) {
						var i = Ks.defaultGrammarValidatorErrorProvider.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }),
							a = { message: i, type: Xr.ParserDefinitionErrorType.DUPLICATE_RULE_NAME, ruleName: e }
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`
				...
				(t.prototype.ruleFinallyStateUpdate = function () {
					if ((this.RULE_STACK.pop(), this.RULE_OCCURRENCE_STACK.pop(), this.cstFinallyStateUpdate(), this.RULE_STACK.length === 0 && this.isAtEndOfInput() === !1)) {
						var e = this.LA(1),
							r = this.errorMessageProvider.buildNotAllInputParsedMessage({ firstRedundant: e, ruleName: this.getCurrRuleFullName() })
				...
				(t.prototype.subruleInternalError = function (e, r, n) {
					throw (
						(er.isRecognitionException(e) &&
							...
							(this.cstPostNonTerminal(e.partialCstResult, r !== void 0 && r.LABEL !== void 0 ? r.LABEL : n), delete e.partialCstResult),
						e)
					)
				}),
				...
				(t.prototype.consumeInternalError = function (e, r, n) {
					...
					throw (
						(n !== void 0 && n.ERR_MSG
							? (i = n.ERR_MSG)
							: (i = this.errorMessageProvider.buildMismatchTokenMessage({ expected: e, actual: r, previous: a, ruleName: this.getCurrRuleFullName() })),
		...
		Js = (function () {
			...
			return (
				...
				(t.prototype.raiseEarlyExitException = function (e, r, n) {
					for (
						var i = this.getCurrRuleFullName(), a = this.getGAstProductions()[i], o = fa.getLookaheadPathsForOptionalProd(e, a, r, this.maxLookahead), s = o[0], c = [], f = 1;
						f <= this.maxLookahead;
						f++
					)
						c.push(this.LA(f))
				...
				(t.prototype.raiseNoAltException = function (e, r) {
					for (
						var n = this.getCurrRuleFullName(), i = this.getGAstProductions()[n], a = fa.getLookaheadPathsForOr(e, i, this.maxLookahead), o = [], s = 1;
						s <= this.maxLookahead;
						s++
					)
						o.push(this.LA(s))
 ...
 inside top level rule: <` +
	...
	function au(t, e) {
		...
		var n = oe.peek(this.recordingProdStack),
			i = oe.isArray(t) === !1,
			a = i === !1 ? t : t.DEF,
			o = new Pe.Alternation({ definition: [], idx: e, ignoreAmbiguities: i && t.IGNORE_AMBIGUITIES === !0 })
		...
		return (
			...
			oe.forEach(a, function (c) {
				...
				o.definition.push(f),
					oe.has(c, "IGNORE_AMBIGUITIES") ? (f.ignoreAmbiguities = c.IGNORE_AMBIGUITIES) : oe.has(c, "GATE") && (f.ignoreAmbiguities = !0),
