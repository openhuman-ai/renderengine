...
class SceneOptimizer {
	...
	getMaterialPropertiesHash(material) {
		const mapProps = ["map", "alphaMap", "aoMap", "bumpMap", "displacementMap", "emissiveMap", "envMap", "lightMap", "metalnessMap", "normalMap", "roughnessMap"]
	...
	getGeometryHash(geometry) {
		const indexHash = geometry.index ? this.bufferToHash(geometry.index.array) : "noIndex"
